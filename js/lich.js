...
function printStyle() {
	...
	res += '  .am {text-align:center;font-size:75%;line-height:100%;color:blue}\n';
	res += '  .am2 {text-align:center;font-size:75%;line-height:100%;color:#004080}\n';
	res += '  .t2t6 {text-align:center;font-size:125%;color:black}\n';
	res += '  .t7 {text-align:center;font-size:125%;line-height:100%;color:green}\n';
	res += '  .cn {text-align:center;font-size:125%;line-height:100%;color:red}\n';
	res += '-->\n';
	res += '</style>\n';
	return res;
}
